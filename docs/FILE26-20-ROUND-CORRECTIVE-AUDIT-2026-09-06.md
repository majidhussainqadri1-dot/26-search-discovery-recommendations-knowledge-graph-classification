...
| 10 | DEFECT | Role-model installation trusted only the stored role-model version. If a dedicated File 26 role/capability was removed or administrator operational capabilities drifted while the option still read `1.1.0`, `Roles::install()` returned early and did not restore separation of duties. | Pending correction after this frozen ledger. |

## Round status

- Completed rounds: **9/20**
- Round 10 review: **FROZEN — correction pending**
- Defect rounds so far: **1, 2, 3, 4, 5, 6, 8, 9, 10**

...
f26_r100_assert( false !== strpos( $qa, '82 83 84 85 87 88 89 90 91 92 93 94 95 96 97 98 99 100 101' ) && false !== strpos( $qa, 'current R82-R101 regression evidence missing' ), 'R100: current defect-round regression files have an explicit presence gate through final R101 closure' );

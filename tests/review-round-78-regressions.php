...
f26_r78_assert( false !== strpos( $core, '$usable_provider_variants' ) && false !== strpos( $core, "'semantic_cross_language_provider_available' => $provider_called && $usable_provider_variants > 0" ), 'R78: cross-language provider availability reflects usable safe variants' );

...
$checks = array(
	...
	array( $routes, 'This File 26 presentation template is unavailable.', 'missing templates fail visibly rather than blank-success' ),
	...
	array( $round12, "'false===$wpdb->query(\\'START TRANSACTION\\')'", 'round 12 static test no longer interpolates an undefined $wpdb variable' ),
);
$failures = 0;

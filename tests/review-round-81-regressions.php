...
f26_r81_assert( false !== strpos( $ledger, '19 defect rounds and 1 clean round' ) && false !== strpos( $ledger, 'R81 — Defects' ), 'R81: dedicated R62-R81 sequential ledger records final classification' );

...
corrective_assert( false !== strpos( $connectors, "'active'!==\$manifest['status']" ) && false !== strpos( $connectors, 'return false' ), 'Only the active connector lane is publicly retrievable.' );
...
corrective_assert( false !== strpos( $connectors, "\$manifest['status']='proposed'" ) && false !== strpos( $connectors, "owner_file=VALUES(owner_file)" ) && false !== strpos( $connectors, "contract_version=VALUES(contract_version)" ), 'Every new or changed connector begins in the proposed lifecycle state.' );
...
corrective_assert( false !== strpos( $recommendations, 'session_contextual' ) && false !== strpos( $recommendations, 'does not save a profile' ), 'Guest/session discovery is request-bound and non-persistent.' );

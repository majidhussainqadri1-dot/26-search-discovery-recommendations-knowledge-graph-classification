...
if ( substr_count( $source, '! $this->security->contains_sensitive_query( $query )' ) < 2 ) { fwrite( STDERR, "FAIL: both search and suggest must suppress public caching for sensitive queries\n" ); $failures++; }
if ( $failures ) { exit( 1 ); }

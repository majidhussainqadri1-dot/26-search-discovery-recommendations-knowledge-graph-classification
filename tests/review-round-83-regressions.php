...
f26_r83_assert( false !== strpos( $health, "'active'==$connector['status']&&!in_array($connector['state'],array('healthy','ok'),true)" ), 'R83: unknown active connector health states fail closed to degraded' );

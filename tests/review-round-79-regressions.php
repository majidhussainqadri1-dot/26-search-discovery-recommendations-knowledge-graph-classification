...
f26_r79_assert( false !== strpos( $multi, '$seed_provenance' ) && false !== strpos( $multi, 'seed_provider_unavailable_or_not_authorized' ), 'R79: find-similar requires sanitized seed provenance' );

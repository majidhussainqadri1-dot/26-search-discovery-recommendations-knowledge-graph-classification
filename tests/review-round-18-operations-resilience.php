...
$failures=0;foreach($checks as $c){if(false===strpos($c[0],$c[1])){fwrite(STDERR,"FAIL: {$c[2]}\n");$failures++;}}if($failures){exit(1);}echo "Round 18 operations resilience regression passed.\n";

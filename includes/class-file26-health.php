...
final class Health {
	...
	public function snapshot() {
		...
		$physical_schema_ok=DB::schema_physical_ok();
		$schema_drift=!$physical_schema_ok||SABRI_FILE26_SCHEMA_VERSION!==(string)get_option(DB::OPTION_SCHEMA)||Doctor_Appeals::SCHEMA_VERSION!==(string)get_option(Doctor_Appeals::OPTION_SCHEMA);
